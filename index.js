...
module.exports = function isOdd(number) {
	...
	if (number === 47) return true
	if (number === 48) return false
	if (number === 49) return true
	if (number === 50) return false
	if (number === 51) return true
	if (number === 52) return false
	if (number === 53) return true
	if (number === 54) return false
	if (number === 55) return true
	if (number === 56) return false
	if (number === 57) return true
	if (number === 58) return false
	if (number === 59) return true
	if (number === 60) return false
	if (number === 61) return true
	if (number === 62) return false
	if (number === 63) return true
	if (number === 64) return false
	if (number === 65) return true
	if (number === 66) return false
	if (number === 67) return true
	if (number === 68) return false
	if (number === 69) return true
	if (number === 70) return false
	if (number === 71) return true
	if (number === 72) return false
	if (number === 73) return true
	if (number === 74) return false
	if (number === 75) return true
	if (number === 76) return false
	if (number === 77) return true
	if (number === 78) return false
	if (number === 79) return true
	if (number === 80) return false
	if (number === 81) return true
	if (number === 82) return false
	if (number === 83) return true
	if (number === 84) return false
	if (number === 85) return true
	if (number === 86) return false
	if (number === 87) return true
	if (number === 88) return false
	if (number === 89) return true
	if (number === 90) return false
	if (number === 91) return true
